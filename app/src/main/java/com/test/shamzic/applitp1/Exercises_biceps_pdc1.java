...
public class Exercises_biceps_pdc1 extends Fragment {

    private Button boutonB ;
    private String val = "";
    private final String exerciseName = "Pompes classiques";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.exercises_biceps_pdc1, container, false);
