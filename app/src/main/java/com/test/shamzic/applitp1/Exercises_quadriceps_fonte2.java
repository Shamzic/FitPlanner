...
public class Exercises_quadriceps_fonte2 extends Fragment {

    private Button boutonB ;
    private String val = "";
    private final String exerciseName = "Front squat";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.exercises_quadriceps_fonte2, container, false);
